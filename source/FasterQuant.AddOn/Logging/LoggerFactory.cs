...
namespace FasterQuant.AddOn
{
    ...
    {
        private string _logConfigFile = "LogConfig.json";
        ...
        private string readConfig(string path)
        {
            ...
            if (!File.Exists(path))
            {
                throw new Exception("The following path does not exist: " + path + ".  Please make sure LoggerConfig.json is deployed with " + Assembly.GetExecutingAssembly().GetName() + ".");
            }
