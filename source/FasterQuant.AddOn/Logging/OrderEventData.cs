...
namespace FasterQuant.AddOn
{
    public class OrderEventData : StrategyEventData
    {
        ...
        public OrderComment OrderComment { get; }
        ...
        public OrderEventData(long portfolioId, string portfolioName, long strategyId, string strategyName, string strategyTradeType, string message, string eventType, string eventSubType, long orderId, int orderIndex, DateTime createDateTime, string type, string status, OrderComment orderComment, int quantity, DateTime fillDateTime, int fillQuantity, double fillPrice, string symbol) : base(portfolioId, portfolioName, strategyId, strategyName, strategyTradeType, message, eventType, eventSubType)
        {
            OrderId = orderId;
            OrderIndex = orderIndex;
            CreateDateTime = createDateTime;
